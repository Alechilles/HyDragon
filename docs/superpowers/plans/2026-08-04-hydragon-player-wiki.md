...
Use these verified drop identities: Hydras provide Ice/Earth materials; Toxic Hydra provides Toxic materials; Nordic Drake provides Ice/Wind and may provide Void; Rock Drakes provide Nature, with Fire on Young/standard variants and Ice on Frost. Plain essence and scales come from all full dragon families. Avoid presenting optional drops as guaranteed.
