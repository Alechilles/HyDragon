...
Revitalizing Essence restores a companion whose Dragon Command Flute card shows confirmed death. Craft it at the **Draconic Altar** in the **Essence** category; revival returns the companion to storage, so summon it separately afterward.

## Recipe

Craft one Revitalizing Essence with:
